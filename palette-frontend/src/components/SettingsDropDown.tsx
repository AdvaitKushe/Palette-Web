    ...
    >
      <div className="flex flex-col gap-2 w-full">
        <div className="flex items-center gap-2">
          <i className="bi bi-info-circle text-zinc-400 cursor-pointer" onClick={() => {
            //window.electron.auth.openExternal('https://platform.openai.com/docs/quickstart')
          }}></i>
        ...
        <div className="flex items-center gap-2">
          <i className="bi bi-info-circle text-zinc-400 cursor-pointer" onClick={() => {
          //  window.electron.auth.openExternal('https://ai.google.dev/gemini-api/docs/api-key')
          }}></i>
        ...
        <div className="flex items-center gap-2 ">
          <i className="bi bi-info-circle text-zinc-400 cursor-pointer" onClick={() => {
           // window.electron.auth.openExternal('https://docs.anthropic.com/en/docs/initial-setup')
          }}></i>
